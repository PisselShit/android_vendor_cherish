...
PRODUCT_COPY_FILES += \
    vendor/cherish/prebuilt/common/etc/sensitive_pn.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sensitive_pn.xml
...
# Pixel APNs
 PRODUCT_COPY_FILES += \
    vendor/cherish/telephony/apns-full-conf.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/apns-conf.xml
